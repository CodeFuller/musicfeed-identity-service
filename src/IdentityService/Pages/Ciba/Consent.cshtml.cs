...
#pragma warning restore CA1724 // Type Names Should Not Match Namespaces
{
	...
	public Consent(IBackchannelAuthenticationInteractionService interaction, IEventService events, ILogger<Index> logger)
	{
	...
	private async Task<ViewModel> BuildViewModelAsync(string id, InputModel model = null)
	{
		...
		logger.LogError($"No backchannel login request matching id: {id}");
